...
$word_to_find = '\${financial-institution}';
$wrap_before = '<span data-input-id="input-institution" class="dynamicInputField">';
$wrap_after  = '</span>';
...
if ( $qualifying_popup_content ) :
	...
	?>
	<div class="modal fade xten-modal dynamicInput" id="contact-qualify-modal" tabindex="-1" role="dialog" aria-labelledby="Contact Form" aria-hidden="true">
...
if ( $rejection_popup_content ) :
	...
	?>
	<div class="modal fade xten-modal dynamicInput" id="contact-rejection-modal" tabindex="-1" role="dialog" aria-labelledby="Contact Form" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<header class="modal-header xten-theme-color-bg">
